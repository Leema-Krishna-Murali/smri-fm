...
| walnut-v0.1: progressive grid ensemble | 0.260 | 0.143 – 0.384 | 0.336 | 1070s | `dd42be1` | 9 progressive CNN heads, shared crops, uniform probability average, threshold 0.165 |
