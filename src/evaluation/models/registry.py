...
from evaluation.models.base import ModelTransformPair
...
def register_model(name_or_func: str | Callable[..., ModelTransformPair] | None = None):
    """Register a model and tranform.
...
def create_model(name: str, **kwargs) -> ModelTransformPair:
    ...
    model, transform = _MODEL_REGISTRY[name](**kwargs)
    return model, transform
